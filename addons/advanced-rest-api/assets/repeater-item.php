<div>
    ...
    <cx-vui-component-wrapper :wrapper-css="[ 'fullwidth-control' ]">
        <div class="cx-vui-inner-panel">
            <cx-vui-repeater button-label="Add Dynamic Inputs" button-size="mini" button-style="accent" v-model="settings.query_parameters" @add-new-item="addNewQueryParameter( $event , 'query_parameters', { 'key': '' , 'from': '' , 'query_var' : '' , 'shortcode' : '' , 'debugShortcode' : '' } )">
